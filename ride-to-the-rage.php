...
<head>
    ...
    <title>Ride to the Rage - Concert Circle</title>
    ...
    <div class="main-content">
        <section class="hero">
            <div class="hero-image">
                <img src="/img/ps-1.jpeg" alt="Travis Scott Concert Crowd">
                ...
                <div class="hero-content">
                    <h2 class="hero-title">
                        <span class="white">Ride to the</span>
                        <span class="purple">Rage</span>
                    </h2>
                    <p class="hero-subtitle">Experience the ultimate Travis Scott concert journey with Concert Circle.</p>
                </div>
            </div>
        </section>
        ...
        <div class="content-area">
            <div class="pdf-title-page" id="pdfTitlePage">
                <h1>Ride to the Rage: Travis Scott Concert Itinerary</h1>
                <p>Saturday, October 18 - Sunday, October 19, 2025</p>
                <p>Jawaharlal Nehru Stadium, Delhi</p>
                <p>Generated on: August 18, 2025, 05:58 PM IST</p>
                <img src="/img/ps-1.jpeg" alt="Travis Scott Concert">
            ...
            <div class="event-info" id="eventInfo">
                ...
                <ul>
                    <li>Experience Travis Scott's Circus Maximus Tour with a budget-friendly package designed for solo fans or low-key travellers.</li>
                    <li>Concert Circle handles all essentials - travel, stay, and local transfers — so you focus only on the music.</li>
                    <li>Stay close to the action with shared 3-star accommodation and on-ground support for a stress-free night.</li>
                    <li>Book a call now to connect with our crew, for an unforgettable but chaos-free concert trip.</li>
                </ul>
            </div>
            ...
            <div id="Experiences" class="tabcontent" style="display: block;">
                <div class="experiences">
                    ...
                    <div class="experience-category">
                        ...
                        <div class="experience-grid">
                            <div class="experience-item">
                                ...
                                <p><strong>Flights</strong><br>Premium airline options with flexible timings</p>
                            </div>
                            <div class="experience-item">
                                <img src="/img/r1.jpg" alt="Trains">
                                <p><strong>Trains</strong><br>Comfortable AC compartments for budget travelers</p>
                            </div>
                            <div class="experience-item">
                                <img src="https://images.unsplash.com/photo-1570125909232-eb263c188f7e?w=800&h=400&fit=crop&auto=format&q=90" alt="Buses">
                                <p><strong>Buses</strong><br>Luxury coaches with entertainment systems</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="experience-category">
                        ...
                        <div class="experience-grid">
                            <div class="experience-item">
                                <img src="/img/r2.jpg" alt="Hotel Town Inn">
                                <p><strong>Hotel Town Inn</strong> <span class="hotel-stars">★★★</span><br>Modern amenities in the heart of Delhi</p>
                            </div>
                            <div class="experience-item">
                                <img src="/img/r3.jpg" alt="Zostel Delhi">
                                <p><strong>Zostel Delhi</strong> <span class="hotel-stars">★★★</span><br>Social hostel with vibrant community</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="experience-category">
                        ...
                        <div class="experience-grid">
                            <div class="experience-item">
                                ...
                                <p><strong>Private Cabs</strong><br>Airport transfers and venue transportation</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="experience-category">
                        ...
                        <div class="experience-grid">
                            <div class="experience-item">
                                ...
                                <p><strong>Lord of the Drinks</strong><br>Premium dining and nightlife experience</p>
                            </div>
                            <div class="experience-item">
                                <img src="/img/r5.jpg" alt="Connaught Place">
                                <p><strong>Connaught Place</strong><br>Historic shopping and cultural district</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="itinerary">
                    ...
                    <div id="Day1" class="day-content">
                        ...
                        <div class="day-item-square">
                            ...
                            <p><strong>7:05 AM</strong><br>Take an early IndiGo/Air India flight from Mumbai Chhatrapati Shivaji International Airport</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r920.jpg" alt="Arrival Delhi">
                            <p><strong>9:20 AM</strong><br>Land at Indira Gandhi International Airport, New Delhi</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r945.jpg" alt="Airport Transfer">
                            <p><strong>9:45 AM - 10:35 AM</strong><br>Airport transfer from Terminal 3 to your hotel</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r1035.jpg" alt="Hotel Check-in">
                            <p><strong>10:35 AM - 12:00 PM</strong><br>Check into your hotel and freshen up</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r1230.png" alt="Lunch">
                            <p><strong>12:30 PM</strong><br>Complimentary lunch or head out to Mesa at Lodhi or Indian Accent</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r200.jpg" alt="Explore Delhi">
                            <p><strong>2:00 PM - 4:30 PM</strong><br>Explore Delhi: Relax at Lodhi Garden or Khan Market</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r430.jpg" alt="Hotel Chill">
                            <p><strong>4:30 PM - 5:30 PM</strong><br>Chill at your hotel, freshen up for the concert</p>
                        </div>
                        <div class="day-item-square">
                            ...
                            <p><strong>5:30 PM - 6:30 PM</strong><br>Dinner/drinks at Juniper Bar or Ping's Cafe Orient</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r630.png" alt="Cab to Venue">
                            <p><strong>6:30 PM</strong><br>Private cab transfer to the concert venue</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r730.jpg" alt="Arrive at Venue">
                            <p><strong>7:30 PM</strong><br>Arrive at Jawaharlal Nehru Stadium, security check</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r800.png" alt="Concert">
                            <p><strong>8:00 PM onwards</strong><br>Travis Scott Concert begins - Let's Rage!</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r1200.jpg" alt="Post-Concert">
                            <p><strong>12:00 AM</strong><br>Post-concert: Epic Restro Bar or hotel unwind</p>
                        </div>
                    </div>
            ...
            <div id="Details" class="tabcontent">
                <div class="details">
                    ...
                    <ul>
                        <li>Airport transfers (round trip cab service)</li>
                        <li>Premium 3-Star Hotel & Home stays (Accommodation of your choice)</li>
                        <li>Complimentary meal (Breakfast or lunch included)</li>
                        <li>Personal Concierge (Guide throughout your concert experience)</li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>Cab transfers from hotel to concert venue</li>
                        <li>Beverages, Lunch, Dinner throughout the tour unless mentioned otherwise</li>
        ...
        <div class="pricing-sidebar">
            <h3>Starting From</h3>
            <div class="price-display">₹7,499</div>
...
function showDay(day) {
    ...
    if (selectedDay) {
        ...
        console.error(`Day with ID "${day}" not found.`);
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initialize tabs: Open the first tab (Experiences)
    const firstTabButton = document.querySelector(".tablinks");
    if (firstTabButton) {
        firstTabButton.click(); // Simulate click on the first tab
    }
...
// Preload images for PDF generation
...
async function downloadItinerary() {
    ...
    try {
        ...
        const day1 = document.getElementById('Day1').cloneNode(true);
        const day2 = document.getElementById('Day2').cloneNode(true);
        const day1Title = document.createElement('h3');
        day1Title.textContent = 'Day 1 - Concert Day';
        day1Title.style.color = 'var(--concert-purple)';
        const day2Title = document.createElement('h3');
        day2Title.textContent = 'Day 2 - Departure';
        day2Title.style.color = 'var(--concert-purple)';

        const itineraryContent = document.createElement('div');
        itineraryContent.appendChild(day1Title);
        itineraryContent.appendChild(day1);
        itineraryContent.appendChild(day2Title);
        itineraryContent.appendChild(day2);
        ...
        pdfContainer.appendChild(itineraryContent);

        document.body.appendChild(pdfContainer);

        const opt = {
            margin: [0.4, 0.4, 0.4, 0.4],
            filename: 'Travis_Scott_Fly_to_the_Rage_Itinerary.pdf',
...
// Inclusion icons hover effects
document.querySelectorAll('.inclusion-icons svg').forEach(icon => {
