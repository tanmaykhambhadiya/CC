...
<head>
    ...
    <title>Astro Deluxe Drop - Concert Circle</title>
...
<body>
    ...
    <div class="main-content">
        <section class="hero">
            <div class="hero-image">
                <img src="/img/ps-3.jpeg" alt="Travis Scott Concert Crowd">
                ...
                <div class="hero-content">
                    <h2 class="hero-title">
                        <span class="white">Astro</span>
                        <span class="purple">Deluxe Drop</span>
                    </h2>
                    <p class="hero-subtitle">Tailored for the top tier – a VIP Travis Scott concert experience with Concert Circle.</p>
                </div>
            </div>
        </section>
        ...
        <div class="content-area">
            <div class="pdf-title-page" id="pdfTitlePage">
                <h1>Astro Deluxe Drop: Travis Scott Concert Itinerary</h1>
                <p>Saturday, October 18 - Sunday, October 19, 2025</p>
                <p>Jawaharlal Nehru Stadium, Delhi</p>
                <p>Generated on: August 20, 2025, 08:31 AM IST</p>
                <img src="/img/ps-3.jpeg" alt="Travis Scott Concert">
            ...
            <div class="event-info" id="eventInfo">
                ...
                <ul>
                    <li>Go all-out with a VIP-style Travis Scott experience, combining luxury stays, smooth logistics, and exclusive perks.</li>
                    <li>Includes premium travel, private transfers, and curated pre-launch merch offers.</li>
                    <li>Access high-energy zones while enjoying the comfort of premium hospitality.</li>
                    <li>Book a call now to connect with our crew for a no-stress, all-flex concert trip — you land, we handle the rest.</li>
                </ul>
            </div>
                    ...
                    <div class="experience-category">
                        ...
                        <div class="experience-grid">
                            <div class="experience-item">
                                ...
                                <p><strong>Flights</strong><br>Premium IndiGo/Air India with priority boarding</p>
                            </div>
                            <div class="experience-item">
                                <img src="/img/u1.jpg" alt="Trains">
                                <p><strong>Trains</strong><br>First-class AC compartments for luxury travel</p>
                            </div>
                            <div class="experience-item">
                                <img src="https://images.unsplash.com/photo-1570125909232-eb263c188f7e?w=800&h=400&fit=crop&auto=format&q=90" alt="Buses">
                                <p><strong>Buses</strong><br>VIP coaches with premium amenities</p>
                            </div>
                        </div>
                    </div>
                    <div class="experience-category">
                        ...
                        <div class="experience-grid">
                            <div class="experience-item">
                                <img src="/img/as-1.jpg" alt="Radisson Blu">
                                <p><strong>Radisson Blu</strong> <span class="hotel-stars">★★★★★</span><br>Luxury 5-star stay with spa access</p>
                            </div>
                            <div class="experience-item">
                                <img src="/img/as-2.jpg" alt="Hyatt Regency">
                                <p><strong>Hyatt Regency</strong> <span class="hotel-stars">★★★★½</span><br>Premium 4.5-star with exclusive amenities</p>
                            </div>
                        </div>
                    </div>
                    <div class="experience-category">
                        ...
                        <div class="experience-grid">
                            <div class="experience-item">
                                <img src="/img/as-3.jpg" alt="Private Cabs">
                                <p><strong>Private Cabs</strong><br>Chauffeur-driven transfers for entire trip</p>
                            </div>
                        </div>
                    </div>
                    <div class="experience-category">
                        ...
                        <div class="experience-grid">
                            <div class="experience-item">
                                ...
                                <p><strong>Lord of the Drinks</strong><br>VIP dining and premium cocktails</p>
                            </div>
                            <div class="experience-item">
                                <img src="/img/r5.jpg" alt="Connaught Place">
                                <p><strong>Connaught Place</strong><br>Exclusive shopping and cultural experience</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="Itinerary" class="tabcontent">
                <div class="itinerary">
                    ...
                    <p class="itinerary-note" style="color: var(--muted); margin-bottom: 1rem;">This is a sample itinerary</p>
                    ...
                    <div id="Day1" class="day-content">
                        <h2>Day 1 - Concert Day</h2>
                        <div class="day-item-square">
                            <img src="/img/r600.jpg" alt="Wake Up">
                            <p><strong>6:00 AM</strong><br>Wake up, pack, and get ready for your VIP trip</p>
                        </div>
                        <div class="day-item-square">
                            ...
                            <p><strong>7:05 AM</strong><br>Premium IndiGo/Air India flight from Mumbai</p>
                        </div>
                        <div class="day-item-square">
                        ...
                        <div class="day-item-square">
                            ...
                            <p><strong>9:45 AM - 10:35 AM</strong><br>Private airport transfer to hotel</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/a11035.jpg" alt="Hotel Check-in">
                            <p><strong>10:35 AM - 12:00 PM</strong><br>Early check-in at 4.5-5 star hotel</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r1230.png" alt="Lunch">
                            <p><strong>12:30 PM</strong><br>Gourmet lunch at hotel or Indian Accent</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r200.jpg" alt="Explore Delhi">
                            <p><strong>2:00 PM - 4:30 PM</strong><br>Visit Lodhi Garden or Khan Market with guide</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r430.jpg" alt="Hotel Relaxation">
                            <p><strong>4:30 PM - 5:30 PM</strong><br>Relax at hotel, enjoy spa or amenities</p>
                        </div>
                        <div class="day-item-square">
                            ...
                            <p><strong>5:30 PM - 6:30 PM</strong><br>VIP dinner at Juniper Bar or Mesa at Lodhi</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r630.png" alt="Private Cab to Venue">
                            <p><strong>6:30 PM</strong><br>Private cab to Jawaharlal Nehru Stadium</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r730.jpg" alt="VIP Venue Arrival">
                            <p><strong>7:30 PM</strong><br>VIP entry and high-energy zones</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/r800.png" alt="Concert">
                            <p><strong>8:00 PM onwards</strong><br>Travis Scott Concert with premium hospitality</p>
                        </div>
                        <div class="day-item-square">
                            <img src="/img/a11200.jpg" alt="Post-Concert">
                            <p><strong>12:00 AM</strong><br>VIP lounge at Epic Restro Bar or hotel unwind</p>
                        </div>
                    </div>
                    <div id="Day2" class="day-content">
                        <h2>Day 2 - Departure</h2>
                        <div class="day-item-square">
        ...
        <div class="pricing-sidebar">
            <h3>Starting from</h3>
            <div class="price-display">₹19,999</div>
            <div class="price-subtitle">Per Head</div>
            <div class="inclusion-icons">
                <svg viewBox="0 0 24 24"><path d="M12 12a5 5 0 1 0 0-10 5 5 0 0 0 0 10zm0 2c-4.42 0-8 1.79-8 4v2h16v-2c0-2.21-3.58-4-8-4z"></path></svg>
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M2 10h20v10H2V10zm2 2v6h16v-6H4zm2-4h4v2H6V8zm10 0h2v2h-2V8zM4 14h16v2H4v-2z"/>
                </svg>
                <svg viewBox="0 0 24 24"><path d="M11 9H9V2H7v7H5V2H3v7c0 2.12 1.66 3.84 3.75 3.97V22h2.5v-9.03C11.34 12.84 13 11.12 13 9V2h-2v7zm5-3v8h2.5v8H21V2c-2.76 0-5 2.24-5 4z"></path></svg>
                <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    <script>
        ...
        async function downloadItinerary() {
            ...
            downloadMessage.textContent = 'Your sample itinerary is downloading...';
            ...
            downloadMessage.style.background = 'var(--concert-card)';
            downloadMessage.style.color = 'var(--foreground)';
            downloadMessage.style.padding = '1rem 2rem';
            downloadMessage.style.borderRadius = '0.5rem';
            ...
            try {
                ...
                itineraryElement.querySelectorAll('.day-content').forEach(day => {
                ...
                const opt = {
                    ...
                    filename: 'Travis_Scott_Astro_Deluxe_Drop_Itinerary.pdf',
                    ...
                    pagebreak: { mode: ['css', 'legacy'], avoid: ['.day-item-square', 'h2', '.event-info'] }
                };
                ...
                downloadMessage.textContent = 'Failed to generate PDF. Please try again.';
