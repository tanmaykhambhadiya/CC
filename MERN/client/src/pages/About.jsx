    ...
    <div className="py-12 px-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-center font-heading font-black text-4xl md:text-5xl mb-8">
          ...
          <span className="text-primary">Concert Circle</span>
        </h1>

        {/* Mission */}
        <div className="bg-concert-card border border-concert-border rounded-2xl p-10 mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            <div key={i} className="bg-concert-card border border-concert-border rounded-2xl p-6 text-center">
              <div className="font-heading font-black text-3xl text-primary mb-1">{stat.value}</div>
        ...
        <div className="bg-concert-card border border-concert-border rounded-2xl p-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/packages" className="px-8 py-4 bg-primary rounded-full font-bold text-white hover:bg-primary/80 transition-all">
              Explore Packages
            </Link>
