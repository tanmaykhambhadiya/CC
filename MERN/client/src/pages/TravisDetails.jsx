      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="font-heading font-black text-4xl md:text-5xl mb-4">
            ...
            <span className="text-shimmer">Delhi Concert</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {[
            ...
            <Reveal key={pkg.name} animation="fade-up" delay={idx + 1} duration={600}>
            <div className={`bg-concert-card border rounded-2xl p-8 text-center relative hover-lift ${pkg.popular ? 'border-primary scale-105 glow-border' : 'border-concert-border hover-glow'}`}>
              ...
              <Link to={pkg.link} className="block w-full py-3 bg-primary rounded-xl font-bold text-white btn-animate">Book Now</Link>
            </div>
            </Reveal>
          ))}
        </div>
        ...
        <div className="bg-concert-card border border-concert-border rounded-2xl p-10 text-center glow-border">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:+911234567890" className="px-8 py-4 bg-primary rounded-full font-bold text-white btn-animate">Call Us Now</a>
