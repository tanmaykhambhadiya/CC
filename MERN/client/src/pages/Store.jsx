      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {products.map((product, idx) => (
            <Reveal key={product.id} animation="fade-up" delay={idx + 1} duration={600}>
            <div className="bg-concert-card border border-concert-border rounded-2xl overflow-hidden hover-lift hover-glow group">
              <div className="relative h-64 bg-cover bg-center transition-transform duration-500 group-hover:scale-105 overflow-hidden" style={{ backgroundImage: `url(${product.img})` }}>
              ...
              <div className="p-6">
                ...
                <button className="w-full py-3 bg-primary rounded-xl font-bold text-white btn-animate">
                  Coming Soon
                </button>
              </div>
            </div>
        ...
        <div className="mt-16 bg-concert-card border border-concert-border rounded-2xl p-10 text-center glow-border">
          ...
          <a href="/packages" className="inline-block px-8 py-3 bg-primary rounded-full font-bold text-white btn-animate">
            View Packages
          </a>
        </div>
        </Reveal>
