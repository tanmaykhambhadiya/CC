      ...
      <div className="max-w-[1400px] mx-auto">
        <Reveal animation="fade-down">
          <h1 className="text-center font-heading font-black text-4xl mb-4">
            ...
            <span className="text-shimmer">Near You</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {[
            ...
            <Reveal key={i} animation="fade-up" delay={i + 1} duration={600}>
            <div className={`bg-concert-card border rounded-2xl overflow-hidden hover-lift ${item.active ? 'border-primary glow-border' : 'border-concert-border opacity-60'}`}>
              <div className="h-48 bg-cover bg-center transition-transform duration-500 hover:scale-105 overflow-hidden" style={{ backgroundImage: `url(${item.img})` }} />
              <div className="p-6">
