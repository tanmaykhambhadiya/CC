      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden mb-12">
          ...
          <div className="absolute bottom-8 left-8">
            <h1 className="font-heading font-black text-4xl md:text-5xl mb-2">Astro Deluxe Drop</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['4.5–5 star luxury hotel or villa stay', 'Private airport pick-up & drop-off', 'Curated Local Experience', 'All cab transfers throughout the stay', 'Exclusive pre-launch Travis Scott merch drops', 'Complimentary breakfast', '+2 Experiences'].map((f, i) => (
            ...
            <div className="mt-8 p-6 bg-concert-card border border-concert-border rounded-2xl">
              ...
              <p className="font-heading font-black text-4xl text-primary">₹19,999 <span className="text-lg text-muted font-normal">per head</span></p>
