...
<head>
    ...
    <title>Concert Circle - Copyright</title>
        ...
        <section class="featured-section">
            ...
            <div class="community-container" style="max-width: 800px;">
                <p style="margin-bottom: 20px; color: #ddd; line-height: 1.6;">
                    © 2025 Concert Circle. All rights reserved. All content, including text, images, graphics, and logos, is the property of Concert Circle or its content suppliers and is protected by international copyright laws.
                </p>
                <h3 style="color: #ffd700; margin: 20px 0 10px;">Usage</h3>
                <p style="color: #ddd; line-height: 1.6;">
                    Reproduction, distribution, or modification of any content from this website without prior written permission from Concert Circle is strictly prohibited.
                </p>
                <h3 style="color: #ffd700; margin: 20px 0 10px;">Contact</h3>
                <p style="color: #ddd; line-height: 1.6;">
                    For copyright inquiries or to request permission, please contact us at <a href="mailto:copyright@concertcircle.com" style="color: #52bdfb;">copyright@concertcircle.com</a>.
                </p>
            </div>
        </section>
    </main>
