...
if (isset($_POST['form1'])) {
    ...
    $upload_dir = __DIR__ . '/../uploads/experience/';
    ...
    if ($valid == 1) {
        if (isset($_REQUEST['id'])) {
            ...
            $statement = $pdo->prepare("UPDATE experience_blocks SET title=?, description=?, image_url=?, link=? WHERE id=?");
            $statement->execute([
                $_POST['title'],
                $_POST['description'],
                $image_name,
            ...
            $success_message = 'Experience block updated successfully!';
        } else {
            // Insert new record
...
<section class="content-header">
    <div class="content-header-left">
        <h1><?php echo isset($_REQUEST['id']) ? 'Edit Experience Block' : 'Add Experience Block'; ?></h1>
    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if (!empty($image_url)): ?>
                                    <img src="../uploads/experience/<?php echo htmlspecialchars($image_url); ?>" alt="Experience Image" style="width:150px; margin-top:10px;">
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="form-group">
