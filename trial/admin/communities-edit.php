...
if (isset($_POST['form1'])) {
    ...
    if ($valid == 1) {
        if (isset($_REQUEST['id'])) {
            ...
            $statement = $pdo->prepare("UPDATE communities SET name=?, description=?, banner_image_url=?, members_count=?, tags=?, join_circle_link=?, join_community_link=? WHERE id=?");
            $statement->execute([
                $_POST['name'],
                $_POST['description'],
                $image_name,
...
if (isset($_REQUEST['id'])) {
    ...
    $tags = $result['tags'];
    $join_circle_link = $result['join_circle_link'];
    $join_community_link = $result['join_community_link'];
} else {
    $name = $description = $banner_image_url = $members_count = $tags = $join_circle_link = $join_community_link = '';
}
?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <input type="hidden" name="current_image" value="<?php echo htmlspecialchars($banner_image_url); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if (!empty($banner_image_url)): ?>
                                    <img src="../uploads/communities/<?php echo htmlspecialchars($banner_image_url); ?>" alt="Community Banner" style="width:150px; margin-top:10px;">
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="number" class="form-control" name="members_count" value="<?php echo htmlspecialchars($members_count); ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Tags</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="tags" value="<?php echo htmlspecialchars($tags); ?>" placeholder="Comma-separated tags">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Join Circle Link</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="join_circle_link" value="<?php echo htmlspecialchars($join_circle_link); ?>" placeholder="Link for joining the circle">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Join Community Link</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="join_community_link" value="<?php echo htmlspecialchars($join_community_link); ?>" placeholder="Link for joining the community">
                            </div>
                        </div>
                        <div class="form-group">
