...
if (isset($_POST['form1'])) {
    ...
    if ($valid == 1) {
        if (isset($_REQUEST['id'])) {
            ...
            $statement = $pdo->prepare("UPDATE blogs SET title=?, excerpt=?, content=?, image=?, category=?, author_name=?, author_avatar=?, published_date=? WHERE id=?");
            $statement->execute([
                $_POST['title'],
                $_POST['excerpt'],
                $_POST['content'],
...
if (isset($_REQUEST['id'])) {
    ...
    $title = $excerpt = $content = $image = $category = $author_name = $author_avatar = $published_date = '';
}
?>

<section class="content-header">
    <div class="content-header-left">
        <h1><?php echo isset($_REQUEST['id']) ? 'Edit Blog' : 'Add Blog'; ?></h1>
    </div>
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" name="excerpt" rows="3"><?php echo htmlspecialchars($excerpt); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Content <span>*</span></label>
                            <div class="col-sm-6">
                                <textarea class="form-control" name="content" rows="8" required><?php echo htmlspecialchars($content); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if (!empty($image)): ?>
                                    <img src="../uploads/blogs/<?php echo htmlspecialchars($image); ?>" alt="Blog Image" style="width:150px; margin-top:10px;">
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="author_name" value="<?php echo htmlspecialchars($author_name); ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Author Avatar</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="author_avatar" value="<?php echo htmlspecialchars($author_avatar); ?>" placeholder="e.g. AL">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Published Date <span>*</span></label>
                            <div class="col-sm-6">
                                <input type="date" class="form-control" name="published_date" value="<?php echo htmlspecialchars($published_date); ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
