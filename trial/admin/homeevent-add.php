...
if (isset($_POST['form1'])) {
    ...
    if ($valid == 1 && isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
        ...
        $image_name = '/api/placeholder/280/180'; // Default placeholder image
    }
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="modal_id" value="<?php echo isset($_POST['modal_id']) ? htmlspecialchars($_POST['modal_id']) : ''; ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Link <span>*</span></label>
                            <div class="col-sm-6">
                                <input type="url" class="form-control" name="link" value="<?php echo isset($_POST['link']) ? htmlspecialchars($_POST['link']) : ''; ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
